...
class createtableuseranduserposts1594816193556 {
  ...
  async up(queryRunner) {
    ...
    await queryRunner.query(`CREATE INDEX "IDX_ccb4ae4609bfbf4d022560a3f8c" ON "user_posts" ("id_user") `);
    await queryRunner.query(`CREATE INDEX "IDX_9a616bdfff1c46bddeb8ad78dbf" ON "user_posts" ("id_posts") `);
