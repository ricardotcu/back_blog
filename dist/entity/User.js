...
let User = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("varchar"), _dec5 = (0, _typeorm.Column)("varchar"), _dec6 = (0, _typeorm.ManyToMany)(type => _Posts.Posts), _dec7 = (0, _typeorm.JoinTable)(), _dec(_class = (_class2 = (_temp = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "posts", _descriptor5, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "posts", [_dec6, _dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
